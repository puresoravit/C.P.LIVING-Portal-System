...
6. **พิมพ์แล้วแก้ = ออก Rev** — เตือนว่าใบเก่าใช้ไม่ได้ ใบสั่งผลิตต้องพิมพ์ใหม่ครบทั้ง 8 ชุด
...
1. `spec_hash` คำนวณจาก รุ่น+กุ๊น+ความหนา+ผ้าสามตำแหน่ง+ทุกชั้นโครงสร้าง — เก็บเป็น JSON มีโครงสร้าง ห้ามเก็บเป็น text ก้อนเดียว การ override การแสดงผล (`*Label`/`displayOverride`) **ห้ามกระทบค่า hash**
