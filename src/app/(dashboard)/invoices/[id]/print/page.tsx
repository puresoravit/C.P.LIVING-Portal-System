    ...
    >
      ...
      <InvoicePrintBody
        ...
        disclaimer={
          ...
          // กระดาษจริง — ขนาดตัวอักษรคูณสัดส่วนเดียวกับตัวเอกสาร (0.83 เท่าของ Body) —
          // Owner UAT (2026-08-31) สี text-gray-600 เดิมจางเกินไปเทียบกับส่วนอื่นที่เป็น
          // ตัวหนา/สีเข้ม เปลี่ยนเป็น gray-900 ให้เข้มเท่ากัน — รอบ 4: Owner ระบุจุดตัด
          // บรรทัดตรงๆ (แยก 2 <div> แทนปล่อยให้ Wrap เองตามความกว้างคอลัมน์ที่เปลี่ยนไป
          // ตามรอบ Font-size ต่างๆ) กันข้อความขึ้นบรรทัดผิดจุดโดยไม่ตั้งใจ
