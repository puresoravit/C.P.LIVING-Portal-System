...
// CP7 round 3 (2026-08-30, Owner UAT) — "บันทึกผลขึ้นของ" ต้องเป็นหมวดใหญ่แยกเมนูของตัวเอง
// ต่อจาก "การขึ้นของและจัดส่ง" เลย (ไม่ใช่แค่ section ในหน้าเดียวกันอีกต่อไป) — ย้าย
// "ข้อมูลผ้าและโครงสร้าง" ลงมาอยู่หลัง "ของค้างส่ง" ตามที่สั่ง (ไม่ใช่เมนูใช้งานประจำวัน)
