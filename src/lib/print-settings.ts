...
> = {
  continuous: {
    ...
    // เข้าที่แล้ว แต่คอลัมน์ราคา/จำนวนเงินฝั่งขวายังตกขอบอยู่ (สาเหตุหลักคือความกว้าง
    // คอลัมน์เดิมคำนวณไว้สำหรับฟอนต์ปกติ ไม่พอสำหรับฟอนต์ +30% ที่ขยายเฉพาะใบส่งของ —
    // แก้ที่ invoice-print-body.tsx แล้ว) — เผื่อ Margin ขวาเพิ่มอีกชั้นเป็น 14mm กันขอบ
    // จริงของเครื่อง Dot-matrix ที่อาจแคบกว่าที่ CSS @page คำนวณไว้ (4 ค่า = บน ขวา ล่าง
    // ซ้าย) — ยังไม่มีการพิมพ์กระดาษจริงยืนยันรอบใหม่ ต้องตรวจกับเครื่อง EPSON LQ-310 จริง
    margin: "10mm 14mm 6mm 10mm",
