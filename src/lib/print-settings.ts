...
> = {
  continuous: {
    ...
    // — เพิ่ม Margin บน 6→10mm และซ้าย-ขวา 8→10mm ให้เนื้อหาเข้ามาจากขอบมากขึ้น
    // (4 ค่า = บน ขวา ล่าง ซ้าย) — ยังไม่มีการพิมพ์กระดาษจริงยืนยันรอบใหม่ ต้องตรวจกับ
    // เครื่อง EPSON LQ-310 จริงอีกครั้ง
    margin: "10mm 10mm 6mm 10mm",
    contentHeightMm: 279.4 - 16, // 11in - (10mm บน + 6mm ล่าง)
  },
  a4: {
